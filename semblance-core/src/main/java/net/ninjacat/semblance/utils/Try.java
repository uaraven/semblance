...
public abstract class Try<T> {
     ...
     */
    public static <P, T> FunctionExecutor<T, P> execute(final Function<P, T> func) {
    ...
    /**
     * Retrieves result of computation from Try wrapped in {@link Optional}.
     * If execution was successful it will return it, otherwise {@link Optional#empty()} will be returned.
     *
    ...
    public static final class FunctionExecutor<R, P> {
        ...
        private FunctionExecutor(final Function<P, R> function) {
